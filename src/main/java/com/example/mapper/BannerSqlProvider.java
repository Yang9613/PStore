...
import com.example.model.BannerExample.Criteria;
import com.example.model.BannerExample.Criterion;
...
public class BannerSqlProvider {
    ...
    public String insertSelective(Banner record) {
        ...
        if (record.getFavcategory() != null) {
            VALUES("favcategory", "#{favcategory,jdbcType=VARCHAR}");
        }
        
        if (record.getBannername() != null) {
            VALUES("bannername", "#{bannername,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getBannername() != null) {
            SET("bannername = #{record.bannername,jdbcType=VARCHAR}");
        }
